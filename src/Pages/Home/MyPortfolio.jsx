    ...
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        ...
        <div>
            ...
            <a href="https://github.com/CHANDINIADARI"  target="_blank" rel="noopener nooreferrer"><button className="btn btn-github"> Vist my GitHub</button></a>
          ...
          <div key={index} className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              ...
              <p className="text-sm portfolio--link">
                {item.link}
                <svg
                  xmlns="https://github.com/CHANDINIADARI"
                  width="16"
                  height="16"
                  viewBox="0 0 20 19"
                  fill="none"
